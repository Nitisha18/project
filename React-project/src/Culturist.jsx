              ...
              <div className="cards-grid">
                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    >
                      ❤ {likes[`${selectedState}-${selectedCity}-${selectedSeason}-festivals`] || 0}
                    </button>
                  </div>
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">🍽 Local Cuisine</h3>
                    <button
                      className="like-button"
                      onClick={() => handleLike('food')}
                    >
                      ❤ {likes[`${selectedState}-${selectedCity}-${selectedSeason}-food`] || 0}
                    </button>
                  </div>
                  <div className="card-content">
                ...
                <div className="card">
                  <div className="card-header">
                    <h3 className="card-title">🏛 Must Visit</h3>
                    <button
                      className="like-button"
                      onClick={() => handleLike('monuments')}
                    >
                      ❤ {likes[`${selectedState}-${selectedCity}-${selectedSeason}-monuments`] || 0}
                    </button>
                  </div>
                  <div className="card-content">
                ...
                <div className="card full-width-card">
                  <div className="card-header">
                    ...
                    >
                      ❤ {likes[`${selectedState}-${selectedCity}-${selectedSeason}-lifestyle`] || 0}
                    </button>
                  </div>
                  <div className="card-content">
